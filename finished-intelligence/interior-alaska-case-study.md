...
### Sextortion Targeting Younger Military Members

A follow-up message after the original post described a pattern affecting younger service members in the area: scammers create fake dating-app profiles (commonly catfishing with stolen photos), build a connection with the target, exchange explicit images, and then threaten to leak the images to the victim's family, friends, or chain of command unless paid — typically in the range of $100–$500.

This matches a well-documented, ongoing threat that the U.S. Army and Army CID have publicly warned about: junior service members are disproportionately targeted because they tend to be young, away from home, financially stable relative to civilians of the same age, held to strict conduct standards, and in some cases hold security clearances, all of which raise the stakes of exposure and make them more likely to pay quickly rather than report it. DoD officials note that sextortion against service members is widely underreported, largely due to embarrassment, and that operators behind these schemes are frequently part of organized criminal networks operating overseas. Army guidance is direct: never exchange compromising photos or videos with someone met online, lock down social media privacy settings, and report incidents to CID rather than paying, since payment rarely ends the extortion and often invites further demands.
...
- **Scale varies, mechanics don't** — a gas station skimmer and the Change Healthcare ransomware attack both come down to exploiting a security gap for financial/data gain, just at vastly different scales.
...
- U.S. Army / Army Criminal Investigation Division (CID) — public guidance on sextortion and social media scams targeting service members
